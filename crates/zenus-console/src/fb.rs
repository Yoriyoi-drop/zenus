...
pub fn clear() {
    if !FB_INIT.load(Ordering::Acquire) { return; }
...
fn draw_char_glyph(c: u8, x: u64, y: u64, fg_r: u8, fg_g: u8, fg_b: u8, bg_r: u8, bg_g: u8, bg_b: u8) {
    let glyph = match c {
        ...
        match byte {
            ...
            b'\t' => {
                ...
                loop {
                    ...
                    draw_char_glyph(b' ', base_x as u64, base_y as u64, 0xAA, 0xAA, 0xAA, 0, 0, 0);
            ...
            0x20..=0x7E => {
                ...
                if cx < cols {
                    ...
                    draw_char_glyph(byte, base_x as u64, base_y as u64, 0xAA, 0xAA, 0xAA, 0, 0, 0);
                    CURSOR_X.fetch_add(1, Ordering::Relaxed);
                }
            }
            _ => {}
...
const FONT_DATA: &[Glyph; 95] = &[
    ...
    [0x00,0x00,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x00,0x00,0x18,0x18,0x00,0x00,0x00], // 0x21 '!'
    ...
    [0x00,0x00,0x00,0x00,0x18,0x18,0x7E,0x3C,0x7E,0x18,0x18,0x00,0x00,0x00,0x00,0x00], // 0x2A '*'
    ...
    [0x00,0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x00,0x18,0x18,0x18,0x30,0x00,0x00,0x00], // 0x3B ';'
    ...
    [0x00,0x00,0x7C,0xC6,0xC6,0x0C,0x18,0x18,0x18,0x00,0x00,0x18,0x18,0x00,0x00,0x00], // 0x3F '?'
    ...
    [0x00,0x00,0xFE,0x62,0x60,0x64,0x7C,0x64,0x60,0x60,0x62,0xFE,0x00,0x00,0x00,0x00], // 0x45 'E'
    [0x00,0x00,0xFE,0x66,0x62,0x64,0x7C,0x64,0x60,0x60,0x60,0xF0,0x00,0x00,0x00,0x00], // 0x46 'F'
    ...
    [0x00,0x00,0xC6,0xC6,0xE6,0xF6,0xDE,0xCE,0xC6,0xC6,0xC6,0xC6,0x00,0x00,0x00,0x00], // 0x4E 'N'
    ...
    [0x00,0x00,0xC6,0xC6,0xC6,0xC6,0xD6,0xD6,0xD6,0xFE,0x6C,0x44,0x00,0x00,0x00,0x00], // 0x57 'W'
    [0x00,0x00,0xC6,0xC6,0x6C,0x7C,0x38,0x38,0x7C,0x6C,0xC6,0xC6,0x00,0x00,0x00,0x00], // 0x58 'X'
    [0x00,0x00,0xC6,0xC6,0xC6,0x6C,0x38,0x10,0x10,0x10,0x10,0x38,0x00,0x00,0x00,0x00], // 0x59 'Y'
    [0x00,0x00,0xFE,0xCE,0x8C,0x18,0x30,0x60,0xC0,0xC6,0xC6,0xFE,0x00,0x00,0x00,0x00], // 0x5A 'Z'
